...

{
  ...
  "description": "This vendor agnostic client handles any GET tracking request. It extracts information from the query string, headers, IP, and cookies and returns the data to the server container as an event object.",
  "containerContexts": [
    "SERVER"
  ]
}
...
Created on 26/04/2021, 12:39:55
