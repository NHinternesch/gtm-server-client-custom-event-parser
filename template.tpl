...

{
  ...
  "description": "This vendor agnostic client handles any tracking request. It extracts information from the query string, headers, IP, and cookies and returns the data to the server container as an event object.",
  "containerContexts": [
    "SERVER"
  ]
}
...
Created on 10/04/2021, 16:43:56
